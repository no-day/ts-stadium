 ...
 * @category Callback
 */
export const createCbRender = <SM extends StateMachine>(stateMachine: SM) => <
  B
>(
...
}): B => createRender(stateMachine)(renderStates)(opts.state)(opts.onEvent);
 ...
 * @category Callback
 */
export const createEventHandler = (control: any) => (st: [any, any]) => (
  event: any
): void => 1 as any;
